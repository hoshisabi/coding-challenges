...
if __name__ == '__main__':
    # data, expected1, expected2 = get_data("aoc-input/aoc2025-02.txt"), 23701357374, 34284458938
    data, expected1, expected2 = get_data("aoc-input/aoc2025-02-test.txt"), 1227775554, 4174379265
