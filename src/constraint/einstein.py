...
def main():
    ...
    for i in range(1, 6):
        ...
        problem.addVariable("nationality%d" % i, ["brit", "swede", "dane", "norwegian", "german"])
        problem.addVariable("drink%d" % i, ["tea", "coffee", "milk", "beer", "water"])
        problem.addVariable("smoke%d" % i, ["pallmall", "dunhill", "blends", "bluemaster", "prince"])
...
def show_solution(solution):
    for i in range(1, 6):
        print(f"House {i}")
        print("--------")
        print(f'Nationality: {solution["nationality%d" % i]}')
        print(f'Color: {solution["color%d" % i]}')
        print(f'Drink: {solution["drink%d" % i]}')
        print(f'Smoke: {solution["smoke%d" % i]}')
        print(f'Pet: {solution["pet%d" % i]}')
        print()
