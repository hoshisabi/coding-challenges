...
if __name__ == '__main__':
    data, expected1, expected2 = get_data("input/aoc2025-03.txt"), 17332, 3121910778619
    # data, expected1, expected2 = get_data("input/aoc2025-03-test.txt"), 357, 3121910778619
